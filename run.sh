...
if [ ! -d "redcap_cypress" ]; then
    git clone -b utah-v16.0.11 git@github.com:uofu-ccts/redcap_cypress.git
    git clone -b utah-v16.0.11 git@github.com:uofu-ccts/redcap_docker.git
    ...
    cd redcap_cypress
    git clone -b utah-v16.0.11 git@github.com:uofu-ccts/redcap_rsvc.git
    cd ..
fi
