...
git pull
git fetch https://github.com/uofu-ccts/redcap_cypress_docker utah-v17.3.6
...
git fetch https://github.com/uofu-ccts/redcap_rsvc utah-v17.3.6
...
cd redcap_cypress
git pull
git fetch https://github.com/uofu-ccts/redcap_cypress utah-v17.3.6
